...
public:
	...
	void SetZClipDistance(float hither, float yonder){zNear = hither, zFar = yonder; };
	float GetZHither(){return zNear; };
	float GetZYonder(){return zFar; };
...
private:    
	...
	float			   zNear, zFar;					   //Set z clipping distance for projection matrix
